...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let viewModel = CurrenciesViewModel(downloadService: downloadService, requestConstructor: requestConstructor, viewModelDataSource: DataSource(), countriesDataSource: countriesDataSource, operationQueue: OperationQueue(), searchCurrency: "EUR")
